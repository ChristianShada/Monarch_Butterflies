...
adultSightingsdata = "/static/journey_north/JNorth_Adult_Site_2017_8.geojson"
d3.json(adultSightingsdata).then(function(data) {
  ...
  eggFirstSightingdata = "/static/journey_north/JNorth_Adult_Site_2020_1.geojson"
...
// Looping through our intervals to generate a label with a colored square for each interval.
  ...
  adultSightingsdata = "/static/journey_north/JNorth_Adult_Site_2016_1.geojson"
  d3.json(adultSightingsdata).then(function(data) {
    // console.log(data);
    L.geoJson(data, {
